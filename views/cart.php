...
<div class="border border-2 ms-4 me-4 mt-4 media view_item">
    ...
    <form action="<?= ROOT_PATH.'cart' ?>" method="POST">
            ...
            <tbody class="fs-5">
                ...
                <?php foreach($produits as $produit): ?>
                    <tr scope="row">
                        ...
                        <br/>
                        <button class="btn btn-style btn-height" type="submit" name="delete" value="<?= $produit["id"] ?>"><i class="bi bi-trash px-1"></i>Supprimer</button></td>
                        <td><?= $produit["price"] ?> €</td>
        ...
        <input class="btn btn-style mb-2 mx-1" type="submit" value="Valider la commande" name="submit">
    </form>
</div>
<br/>